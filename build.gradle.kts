...
subprojects {
    ...
    dependencies {
        ...
        testImplementation("io.kotest:kotest-extensions-spring:${project.properties["kotestVersion"]}")
        testImplementation("com.appmattus.fixture:fixture:${project.properties["kotlinFixtureVersion"]}")
