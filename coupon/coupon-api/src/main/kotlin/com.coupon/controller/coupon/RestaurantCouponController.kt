...
@Tag(name = "Restaurant Coupon API", description = "레스토랑 쿠폰 API")
@RestController
...
class RestaurantCouponController(
    ...
    @Operation(summary = "레스토랑 쿠폰 배치 생성", description = "오늘의 식당 쿠폰을 배치로 생성합니다. (관리자 전용, 최대 3건)")
    @PostMapping
    ...
    @Operation(
        summary = "레스토랑 쿠폰 발급",
        description = "레스토랑 ID로 연결된 쿠폰을 발급합니다.",
    )
    @PostMapping("/issue")
    ...
    @Operation(summary = "활성 레스토랑 쿠폰 목록 조회", description = "현재 활성화된 레스토랑 쿠폰(오늘의 식당) 목록을 조회합니다.")
    @GetMapping("/active")
    ...
    @Operation(summary = "레스토랑 쿠폰 삭제", description = "레스토랑 쿠폰을 삭제합니다. (관리자 전용)")
    @DeleteMapping("/{id}")
