...
class SlackWebhookMessageSenderTest :
    BehaviorSpec({
        given("SlackWebhookMessageSender가 incoming webhook을 호출하면") {
...
private fun slackWebhookClient(webhookUrl: String): SlackWebhookMessageSender =
    SlackWebhookMessageSender(
